...
@Component({
  selector: 'hh-admincompany-comunicado-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './admincompany-comunicado-form.component.html'
})
export class AdmincompanyComunicadoFormComponent implements OnInit, OnDestroy {
