...
@Component({
  selector: 'hh-admincompany-documento-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './admincompany-documento-form.component.html'
})
export class AdmincompanyDocumentoFormComponent implements OnInit, OnDestroy {
