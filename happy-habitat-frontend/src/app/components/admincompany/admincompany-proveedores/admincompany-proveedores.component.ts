...
@Component({
  selector: 'hh-admincompany-proveedores',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, CommunityFilterComponent],
  templateUrl: './admincompany-proveedores.component.html'
})
export class AdmincompanyProveedoresComponent implements OnInit {
