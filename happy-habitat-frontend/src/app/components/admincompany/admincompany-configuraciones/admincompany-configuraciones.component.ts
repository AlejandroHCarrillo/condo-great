...
@Component({
  selector: 'hh-admincompany-configuraciones',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, CommunityFilterComponent],
  templateUrl: './admincompany-configuraciones.component.html'
})
export class AdmincompanyConfiguracionesComponent implements OnInit {
