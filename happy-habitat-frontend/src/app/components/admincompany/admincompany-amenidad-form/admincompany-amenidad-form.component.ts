...
@Component({
  selector: 'hh-admincompany-amenidad-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './admincompany-amenidad-form.component.html'
})
export class AdmincompanyAmenidadFormComponent implements OnInit, OnDestroy {
